  ...
  return (
    <div className="flex h-full w-full items-center justify-between bg-[#0b0d2d] px-4 md:px-8">
      ...
      <nav className="hidden items-center gap-2 text-xs uppercase text-white md:flex lg:text-sm">
        ...
        <a href="#view-site" className="underline underline-offset-2">View site</a>
        <span>/</span>
        <a href="#change-password" className="underline underline-offset-2">Change password</a>
        <span>/</span>
        <a href="/" className="underline underline-offset-2">Log out</a>
      </nav>
    </div>
  )
}
