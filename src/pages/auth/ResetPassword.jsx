  ...
  return (
    ...
    >
      <section className="flex w-full max-w-[390px] flex-col items-center">
        ...
        <h1 className="mb-4 text-2xl font-normal text-[#ff823d]">
          Reset Password
        </h1>
        ...
        >
          ...
          {passwordError && (
            <p className="mb-3 text-center text-xs text-[#ff823d]">
              {passwordError}
            </p>
          )}
          ...
          <button
            type="submit"
            className="mx-auto mt-2 h-9 w-28 rounded-[6px] bg-[#ff823d] text-xs font-semibold text-white transition-opacity hover:opacity-90 cursor-pointer"
          >
            RESET PASSWORD
          </button>
        </form>
