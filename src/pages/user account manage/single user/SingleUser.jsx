...
const SingleUser = () => {
  ...
  return (
    <main className="team-users-page min-h-full bg-white px-2 py-3 text-sm text-[#777] md:px-5 md:py-4">
                    ...
                    >
                      ...
                      <td className="px-1">
                        <button
                          ...
                          onClick={() =>
                            navigate(
                              `/dashboard/single-route-history/${encodeURIComponent(user[1])}`,
                            )
                          }
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <button
                type="button"
                onClick={() => setEditUser(null)}
                className="rounded border border-[#bbb] px-3 py-1.5 cursor-pointer"
              >
                CANCEL
              </button>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-2 rounded bg-[#ff823d] px-3 py-1.5 text-white cursor-pointer"
              >
                <Upload size={15} />
                Choose CSV
              </button>
