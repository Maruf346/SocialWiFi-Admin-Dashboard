...
const SingleUserRouteHistory = () => {
  const navigate = useNavigate()
  const { userEmail } = useParams()

  return (
    <main className="min-h-full bg-white px-2 py-3 text-sm text-[#777] md:px-8 md:py-6">
      <button type="button" onClick={() => navigate(-1)} className="mb-5 underline cursor-pointer">Back to single user</button>
...
export default SingleUserRouteHistory